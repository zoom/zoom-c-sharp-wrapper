...
SDKError InitIPreMeetingServiceFunc(ZOOM_SDK_NAMESPACE::IPreMeetingService** pObj, ZOOM_SDK_NAMESPACE::IPreMeetingServiceEvent* pEvent)
{
	ZOOM_SDK_NAMESPACE::IPreMeetingService* pService(NULL);
	SDKError result = CSDKImpl::GetInst().CreatePreMeetingService(&pService);
...
SDKError IPreMeetingServiceWrap::Init()
{
	m_obj = NULL;
	return InitIPreMeetingServiceFunc(&m_obj, this);
}

void IPreMeetingServiceWrap::Uninit()
{
	UninitIPreMeetingServiceFunc(m_obj);
	m_obj = NULL;
}
